...
int Renderer::initWidth, Renderer::initHeight;
...
VkSemaphore Renderer::m_imageAvailableSemaphore, Renderer::m_renderFinishedSemaphore;

void Renderer::init(GLFWwindow* window, int winWidth, int winHeight)
{
    m_glfwWindow = window;
    initWidth = winWidth;
...
{
    auto vertShaderCode = readFile("/Users/sebastianwyngaard/Documents/programming/cpp_proj/IslandEngine/assets/shaders/vert.spv");
    auto fragShaderCode = readFile("/Users/sebastianwyngaard/Documents/programming/cpp_proj/IslandEngine/assets/shaders/frag.spv");
...
VkExtent2D Renderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
    if (capabilities.currentExtent.width != UINT32_MAX) {
        ...
        VkExtent2D actualExtent = {(uint32_t)initWidth, (uint32_t)initHeight};
